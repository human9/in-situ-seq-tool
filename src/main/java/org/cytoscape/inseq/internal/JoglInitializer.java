...
{	
	...
	private static final String GLUEGEN_JAR = "gluegen-rt-2.3.2.jar";
	private static final String JOGL_JAR    = "jogl-all-2.3.2.jar";
	...
	private static JarUtil.Resolver createJarResolver(final Map<String,String> pathMap) 
	{
		...
		{			
            List<String> gluegenPrefixes = Arrays.asList("/com/jogamp/common", 
					                                     "/com/jogamp/gluegen", 
					                                     "/jogamp/common");
